...
func (e *Executor) hooksRunPreBuild() (time.Duration, error) {
	start := time.Now()
...
func (e *Executor) hooksRunPostBuild() (time.Duration, error) {
	start := time.Now()
	var dur time.Duration
...
func (e *Executor) hooksRunPreStart() (time.Duration, error) {
	start := time.Now()
	var dur time.Duration
...
func (e *Executor) hooksRunPostStart() {
	<-e.canRunPostStart
